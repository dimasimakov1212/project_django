...
SECRET_KEY = 'django-insecure-u3+nwq_!t5(4g8zh$vcd-*d(%za(!z-g27=_tx126b!0hc!wad'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'project_django',  # Название БД
        'USER': 'postgres',  # Пользователь для подключения
        'PASSWORD': 'dima123',  # Пароль для этого пользователя
